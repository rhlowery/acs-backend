...
public class MockServiceDeepTest {
    ...
    public void testEdgeBranches() {
        ...
        AccessRequest req = new AccessRequest("p", "u", "u", "USER", "c", "s", "t", "TABLE", List.of("S"), "PENDING", 0L, null, "j", null, null, null, null);
        service.saveRequests(List.of(req), "u", emptyGroups, false);
        
        AccessRequest update = new AccessRequest("p", null, null, null, null, null, null, null, null, "APPROVED", null, null, null, null, null, null, null);
