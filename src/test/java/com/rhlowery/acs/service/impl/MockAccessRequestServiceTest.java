...
public class MockAccessRequestServiceTest {
    ...
    public void testMockServiceSymmetry() {
        ...
        AccessRequest req = new AccessRequest("id1", "u1", "u1", "USER", "c", "s", "t", "TABLE", List.of("SELECT"), "PENDING", 0L, null, "j", null, List.of("data-owners"), null, null);
        ...
        AccessRequest partial = new AccessRequest("id1", null, null, null, null, null, "new_table", null, null, null, null, null, "new_just", null, null, null, null);
    ...
    public void testForbiddenUpdate() {
        MockAccessRequestService service = new MockAccessRequestService();
        AccessRequest req = new AccessRequest("id1", "u1", "u1", "USER", "c", "s", "t", "TABLE", List.of("SELECT"), "PENDING", 0L, null, "j", null, null, null, null);
        service.saveRequests(List.of(req), "u1", List.of("users"), false);
        
        // Try update as another non-admin user
        AccessRequest update = new AccessRequest("id1", "u2", "u2", "USER", "c", "s", "t", "TABLE", List.of("SELECT"), "APPROVED", 0L, 0L, "j", null, null, null, null);
    ...
    public void testAdminUpdateStatus() {
        ...
        AccessRequest update = new AccessRequest("id1", "u1", "u1", "USER", "c", "s", "t", "TABLE", List.of("SELECT"), "REJECTED", 0L, 0L, "j", null, null, null, null);
